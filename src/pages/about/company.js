...
const PortfolioLayout = () => {
    ...
    <section className="flex flex-col md:flex-row-reverse items-center md:items-start gap-8">
        ...
        <div className="md:w-1/3 flex items-center">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-[Frutiger] font-bold text-[#124e66] text-center md:text-right">
    ...
    <section className="flex flex-col md:flex-row items-center md:items-start gap-8">
        ...
        <div className="md:w-2/3">
            <p className="text-gray-700 leading-relaxed font-[Calibri] text-lg">
                Professionals Spotlight goes beyond being a content platform—we are your dedicated partner in growth. Our relentless focus on authenticity, quality, and personalized storytelling sets us apart. We work closely with CEOs, students, and professionals to craft tailored narratives that spotlight their accomplishments and engage their target audience. Our SEO-optimized content ensures that when people search for your name or business, your story rises to the top, maximizing visibility and impact. Let us help you create compelling, polished content that reflects your unique journey and positions you for long-term success in your career or studies.
            </p>
        </div>
    </section>
</main>
