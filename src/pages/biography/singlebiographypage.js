      ...
      <div className="min-h-screen bg-white">
        <div className="relative space-y-2 bg-center mt-5 sm:mt-10 px-4 sm:px-10 rounded-lg w-full">
          <div className="relative   bg-[#124e66] ">
            <div className="bg-[#124e66] h-[26rem] md:h-[34rem] w-full overflow-hidden">
              <img
                className="object-fill w-full lg:min-w-[55%] lg:max-w-[55%] mx-auto  h-full bg-center "
                src={biography?.banner}
                alt={biography?.title}
              />
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black to-transparent p-4">
                <h1 className="text-lg sm:text-3xl text-center sm:mb-6 font-semibold font-[Frutiger] text-white">
                  {biography?.title}
                </h1>
              </div>
            </div>
